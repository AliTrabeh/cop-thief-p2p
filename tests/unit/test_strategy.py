...
(core legality/pursuit/evasion behavior; the expected-distance-algorithm
tests live in test_strategy_expected_distance.py and the pluggable-loader
tests live in test_strategy_loader.py, split out to keep each file under
150 lines).
"""
